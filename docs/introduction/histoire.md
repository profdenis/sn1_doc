...
- **Fonctionnement** :
    ...
    - Ada Lovelace (mathématicienne) a écrit le premier **algorithme** pour cette machine (considéré comme le premier
      programme informatique).
- **Impact** :
    - Concept de **mémoire**, **unité de calcul** et **programme stocké** — bases de l’architecture des ordinateurs
      modernes.
...
- Outils comme **Scratch** (pour les enfants) ou **Jupyter Notebooks** (pour les scientifiques) rendent la programmation
  plus **accessible**.
