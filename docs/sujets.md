...
1. Semaine 1
    ...
    5. Sortie standard (_stdout_) et entrée standard (_stdin_)
...
- Exercices du livre correspondants chapitres et sections mentionnés à chaque semaine. Commencer par les exercices
  suggérés dans le livre (en bleu).
